    ...
    for i, batch in enumerate(train_loader):
        ...
        with autocast(enabled=args.amp):
            outputs = model.forward(
                ...
                actual_batch_size=actual_batch_size, ### exclude simailar images from generative loss
                # actual_batch_size=len(batch['input_ids']), ### include simailar images from generative loss
            )
